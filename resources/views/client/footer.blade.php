                ...
                <div class="col-xs-12 col-sm-6 col-md-4 footer--widget-about">
                    <div class="footer--widget-content">
                        <img class="mb-20" src="http://demo.zytheme.com/hairy/assets/images/logo/logo-light.png"
                            alt="logo">
                        <p>Proin gravida nibh vel velit auctor aliquet anean lorem quis. bindum auctor, nisi
                            elite conset ipsums sagtis id duis sed odio sit.</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 footer--widget-recent">
                    ...
                    <div class="footer--widget-content">
                        <div class="entry">
                            ...
                            <div class="entry--content">
                                <div class="entry--title">
                                    <a href="#">Essential barbering tips you need to know before you
                                        start</a>
                                </div>
                        ...
                        <div class="entry">
                            ...
                            <div class="entry--content">
                                <div class="entry--title">
                                    <a href="#">Discover what is the best haircut for your face
                                        shape?</a>
                                </div>
                                <div class="entry--meta">
